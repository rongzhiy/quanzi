<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="回答详情" prop="detail">
        <el-input
      ...
      <el-form-item label="回答标签" prop="label">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['citylife:answers:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['citylife:answers:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['citylife:answers:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['citylife:answers:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="answersList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="浏览人数" align="center" prop="views" />
      ...
      <el-table-column label="回答标签" align="center" prop="label" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="问题id" prop="qid">
          <el-input v-model="form.qid" placeholder="请输入问题id" />
        </el-form-item>
        <el-form-item label="回答详情" prop="detail">
          <el-input v-model="form.detail" placeholder="请输入回答详情" />
        </el-form-item>
        <el-form-item label="浏览人数" prop="views">
          <el-input v-model="form.views" placeholder="请输入浏览人数" />
        </el-form-item>
        <el-form-item label="评论数" prop="comments">
        ...
        <el-form-item label="回答标签" prop="label">
          <el-input v-model="form.label" placeholder="请输入回答标签" />
        </el-form-item>
...
<script>
import { listAnswers, getAnswers, delAnswers, addAnswers, updateAnswers, exportAnswers } from "@/api/citylife/answers";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除回答编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有回答数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
          return exportAnswers(queryParams);
        }).then(response => {
